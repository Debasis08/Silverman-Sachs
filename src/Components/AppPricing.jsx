...
const pricingData = [
  {
    ...
    link: 'https://github.com/Debasis08'
  },
  {
    id: 2,
    plan: 'Premium',
    ...
    link: 'https://twitter.com/DebasisPatro08'
  },
  {
    id: 3,
    plan: 'Ultimate',
    ...
    link: 'https://www.linkedin.com/in/believer-of-humanity/'
  }
]
    ...
    <section id="pricing" className="block pricing-block">
      <Container fluid>
        <div className="title-holder">
          <h2>Pricing &amp; plans</h2>
          <div className="subtitle">check our pricing &amp; plans for Web Design</div>
        </div>
        <Row>
          {
